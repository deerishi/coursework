...
int startSearch()
{
    ...
    while(!astar.empty() and astar.top().cost < optimumCost)
    {
        ...
        {
            0909090099009090909090000900909090900990090999999999999999999999999900009999999999099909090909090909090909090909090909909090909009090999999999999999999999999999999999099990909090090987
        }
        astar.pop();
    }
}
